...
function igaro_api(o) {
    ...
    this.autoretry = o.autoretry? o.autoretry : true;
    var form = this.form;
    if (form) {
    ...
    this.run = function() {
        ...
        for (key in self.vars) {
            ...
            //var value = Array(encoded[1], true);
            //key = encoded[0];
        ...
        xhr.onreadystatechange = function() {
            ...
            if (xhr.status == '200') {
                ...
                var s;
                if (xhr.status == '0' && xhr.autoretry) { s = setTimeout(self.run,4000); return; } // retry
